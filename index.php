<?php
/*
  Plugin Name: Themelite Shortcodes Package
  Plugin URI: http://sellweb.in
  Description: Universal Shortcodes Package (Haswell)
  Author: Themelite
  Version: 1.0.3
  Author URI: http://themeforest.net/user/Theme_lite
 */
